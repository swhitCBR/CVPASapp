...
HOR_CHP_pred_comp_ls <- list(
  "AIC_DF_d2"=AIC_DF_d2,
  "mods_w_covmat_ls"=mods_w_covmat_ls, # list of covariance matrices
  "pt_estsDF_ls"=pt_estsDF_ls,
  "logSD_RELGRP_v"=logSD_RELGRP_v, # vector of estimated randrom intercepts
  "TMB_data_baseline"=HOR_CHP_TMB_all_mods$"TMB_data_baseline",
  "data_inputs_ls"=HOR_CHP_mod_dat_sep_ls, # input dat set
  "pt_ests_SE_DF_ls"=pt_ests_SE_DF_ls
)

# saveRDS(HOR_CHP_pred_comp_ls,"HOR_CHP_pred_comp_ls.rds")
# unlink("HOR_CHP_pred_comp_ls.rds")
